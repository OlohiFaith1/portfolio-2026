  ...
  return (
    <section className="min-h-screen flex flex-col">
      <div className="flex-1 flex items-center justify-center px-8">
        <div className="flex flex-col gap-6 text-center w-[320px] max-w-full">
          <h1 className="font-display text-[32px] leading-[1.1] text-foreground">
            Ijelekhai Faith Olohijere
          </h1>
          <p className="text-[16px] leading-[1.55] tracking-[-0.2px] text-muted">
      ...
      <div className="pb-14 flex flex-col items-center gap-5">
