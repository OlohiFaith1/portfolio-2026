...
export function AzzaStudy8() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={wrapRef}
        className="h-[60svh] md:h-[75svh] lg:h-[88svh]"
        style={{ position: 'relative', maxHeight: PH, aspectRatio: `${PW} / ${PH}` }}
      >
        ...
        >
          {/*
            ...
            The section's overflow:hidden clips the far ends at viewport edges.
          */}
          <div
            style={{
              position: 'absolute',
