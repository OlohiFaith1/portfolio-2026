...
export function AboutContent() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#fafafa] pt-[88px] md:pt-[88px] lg:pt-[112px] px-4 md:px-8 lg:px-16 xl:px-24">
        <Image
      ...
      {/* ── Body copy ───────────────────────────────────────────── */}
      <section className="w-full bg-[#fafafa] flex flex-col items-center px-6 md:px-12 pt-16 md:pt-24 lg:pt-[100px] pb-20 md:pb-28 lg:pb-36">
